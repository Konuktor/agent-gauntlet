...
export const ERROR_COPY: Record<ErrorCode, { title: string; hint: string }> = {
  ...
  agent_timeout: { title: "The agent ran out of time", hint: "Raise the task timeout, or the agent is stuck." },
  agent_crashed: { title: "The agent threw an error", hint: "See the action trace and agent output below." },
  agent_loop_detected: {
  ...
  agent_max_steps: { title: "The agent hit its step limit", hint: "It did not finish within maxSteps." },
  evaluator_unavailable: {
  ...
  solari_auth: { title: "Solari rejected the API key", hint: "Rotate or re-copy SOLARI_API_KEY from console.getsolari.com." },
  solari_plan: {
  ...
  solari_capacity: { title: "No Solari capacity right now", hint: "The pool had no host available. Try again shortly." },
  solari_unavailable: { title: "Solari is unreachable", hint: "Check status and your network connection." },
  cancelled: { title: "The run was cancelled", hint: "The worker shut down or you stopped the suite." },
