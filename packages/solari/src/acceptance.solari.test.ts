...
describe.skipIf(!enabled)("Solari acceptance", () => {
  ...
  it("hosts the benchmark site in a sandbox and exposes it on a public URL", async () => {
  ...
  it("drives the task in a recorded browser session and judges it from server state", async () => {
  ...
  it("leaves nothing running", async () => {
